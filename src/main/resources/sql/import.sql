...
INSERT INTO user (user_id, password, email, username, name, last_name, active)  VALUES ('123456789', 'user@mail.com', 'user', 'Name', 'Surname',
   1);

INSERT INTO user (user_id, password, email, username, name, last_name, active)
VALUES
  ('asdqwe', 'johndoe@gmail.com', 'johndoe', 'John', 'Doe', 1);

INSERT INTO user (user_id, password, email, username, name, last_name, active)
VALUES ('zxcasdqwe', 'ana@mail.com', 'ana', 'Ana', 'Surname', 1);
